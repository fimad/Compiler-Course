                  ...
                  fn line => let
                    ...
                    in
                      case line of
                        ...
                        | (LLVM.TailCall (r,t,func,args)) => LLVM.TailCall ((change_result r),t,func,(map (fn (r,t) => (change_arg r,t)) args))
                        | (LLVM.Print (r,t,arg)) => LLVM.Print ((change_result r),t,(change_arg arg))
                        | (LLVM.TailPrint (r,t,arg)) => LLVM.TailPrint ((change_result r),t,(change_arg arg))
